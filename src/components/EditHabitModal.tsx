...
const EditHabitModal: React.FC<EditHabitModalProps> = ({ isOpen, onClose, habit, onUpdate }) => {
  const { t } = useLanguage();
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white dark:bg-gray-800 rounded-2xl max-w-md w-full p-4 sm:p-6 animate-scale-in max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white">{t('editHabitTitle')}</h2>
          <button
            onClick={onClose}
